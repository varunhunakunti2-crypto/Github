  ...
  if (items.length === 0) {
    return (
      <div className="py-xl text-center border border-hairline border-dashed rounded-sm bg-canvas-soft/30">
        ...
        <p className="font-sans text-body text-xs max-w-[280px] mx-auto leading-relaxed mb-md">
          {isOwnProfile
        ...
        {isOwnProfile && (
          <Link
            href="/search"
            className="inline-block bg-primary hover:bg-primary/90 text-white font-sans font-semibold text-xs py-xs px-md rounded-sm transition-colors focus:ring-2 focus:ring-primary-focus outline-none"
          >
            Search developers
          </Link>
        )}
